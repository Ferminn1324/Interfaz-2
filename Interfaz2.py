...
ttk.Label(raiz,text="Product management",font=("verdana",30,"bold"),foreground="white",background="gray40").grid(column=0,row=0,padx=120,sticky=(W))
...
imagen1 = PhotoImage(file="limpiar1.png")
...
data = [
    ...
    ("4", "Producto 4", "Descripcion del producto 4", "30", "$400")
]
